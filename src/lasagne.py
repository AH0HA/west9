# -*- coding: utf-8 -*-
"""
Created on Thu May 14 17:18:41 2015
...
default_path="D:\\kaggle2\\chicago_mosq\\west_nile\\src"
...
def load_training():
    training = []
    for line in csv.DictReader(open("..\\input\\train.csv")):
        for name, converter in {"Date" : date, 
...
def load_testing():
    training = []
    for line in csv.DictReader(open("..\\input\\test.csv")):
        for name, converter in {"Date" : date, 
